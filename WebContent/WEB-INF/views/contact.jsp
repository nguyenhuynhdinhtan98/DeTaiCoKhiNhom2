				...
				<c:if test="${user == null}">
					<div class="topbar__item">
						<div class="topbar-dropdown">
							<button class="topbar-dropdown__btn font-weight-bold text-dark"
								type="button">
				...
				<c:if test="${user != null}">
					<div class="topbar__item">
						<div class="topbar-dropdown">
							<button class="topbar-dropdown__btn font-weight-bold text-dark"
								type="button">
								<p class="text-primary">${user.getTenTaiKhoan()}</p>
								<button class="topbar-dropdown__btn font-weight-bold text-dark"
									id="dangxuat" type="button">Đăng xuất
						</div>
					</div>
				</c:if>
			</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<h2 class="noo-sh-title">
						Cửa hàng <span>ThewayShop</span>
					</h2>
					<p>"Tiền thân của Trường Đại học Công nghiệp thành phố Hồ Chí
						Minh là Trường Huấn nghiệp Gò Vấp do các tu sĩ dòng Don Bosco
						thành lập 11/11/1956 tại xã Hạnh Thông, Quận Gò Vấp, Tỉnh Gia
						Định. Năm 1968, Trường được đổi tên thành Trường tư thục Trung học
						Kỹ thuật đệ nhất cấp Don Bosco. Đến ngày 31/01/1970, Trường được
						cải biên thành Trường tư thục Trung học Kỹ thuật đệ nhị cấp Don
						Bosco, được gọi tắt là Trường Trung học Kỹ thuật Don Bosco. Sau
						ngày hòa bình, thống nhất đất nước, quân giải phóng miền Nam tiếp
						quản và ngày 19/12/1975 Trường được bàn giao cho Tổng cục Cơ khí
						Luyện kim và Điện tử. Năm 1978, Trường được đổi tên thành Trường
						Công nhân Kỹ thuật IV trực thuộc Bộ Cơ khí và Luyện kim. Đến năm
						1994, Trường hợp nhất với Trường Trung học Hóa chất II tại thành
						phố Biên Hòa thành Trường Trung học Kỹ thuật Công nghiệp IV, trực
						thuộc Bộ Công Nghiệp. Tháng 3 năm 1999, Trường được nâng cấp thành
						Trường Cao đẳng Công nghiệp IV và tháng 12 năm 2004, Trường được
						nâng cấp thành Trường Đại học Công nghiệp thành phố Hồ Chí Minh
						theo quyết định số 214/2004/QĐ - TTg của Thủ tướng Chính phủ và
						Trường được Thủ tưởng Chính phủ phê duyệt thí điểm đổi mới cơ chế
						hoạt động giai đoạn 2015-2017 theo quyết định số 902/QĐ-TTg ngày
						23 tháng 6 năm 2015, bắt đầu thực hiện từ năm học 2015 - 2016.
						Trường Đại học Công nghiệp thành phố Hồ Chí Minh là một trong
						những cơ sở giáo dục đại học lớn tại Việt Nam.</p>
				</div>
				<div class="col-lg-6">
			...
			<div class="row my-5">
				...
				<div class="col-sm-6 col-lg-4">
					<div class="service-block-inner">
						...
						<p>Địa chỉ: Xã Quảng Tâm, TP. Thanh Hóa, Tỉnh Thanh Hóa.</p>
					</div>
				</div>
				<div class="col-sm-6 col-lg-4">
					<div class="service-block-inner">
						<h3>Phân hiệu Quảng Ngãi</h3>
						<p>Địa chỉ: 938 Quang Trung, TP. Quảng Ngãi.</p>
					</div>
				</div>
			</div>
			<div class="row my-4">
				<div class="col-12">
					<h2 class="noo-sh-title">Đội ngũ</h2>
				</div>
				<div class="col-sm-6 col-lg-4">
					<div class="hover-team">
						<div class="our-team">
							<img src="<c:url value="./resources/images/tan.jpg"/>" alt=""
								style="height: 302px; width: 350px;">
							<div class="team-content">
								<h3 class="title">Nguyễn Huỳnh Đình Tân</h3>
				...
				<div class="col-sm-6 col-lg-4">
					<div class="hover-team">
						<div class="our-team">
							<img src="<c:url value="./resources/images/hai.jpg"/>" alt=""
								style="height: 302px; width: 350px;">
							<div class="team-content">
								<h3 class="title">Tạ Minh Tiền Hải</h3>
								<span class="post">Web Developer</span>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6 col-lg-4">
					<div class="hover-team">
						<div class="our-team">
							<img src="<c:url value="./resources/images/van.jpg"/>" alt=""
								style="height: 302px; width: 350px;">
							<div class="team-content">
								<h3 class="title">Võ Thị Thanh Vân</h3>
								<span class="post">Tester and document</span>
							</div>
						</div>
					</div>
				</div>
