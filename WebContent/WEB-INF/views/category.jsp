...
<body>
						...
						<li class="dropdown"><a href="#"
							...
							<ul class="dropdown-menu">
								<c:forEach var="danhmuc" items="${danhmuc}">
									<li><a href="${danhmuc.getMaDanhMucSanPham()}">${danhmuc.getTenDanhMuc()}</a></li>
								</c:forEach>
							</ul></li>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="title-all text-center">
						...
						<p>Hoà hợp và phát triển</p>
					</div>
				</div>
			</div>
			<div class="row special-list">
				<c:forEach var="sanpham" items="${sanpham.getSanPhamList()}">
	...
	<script src='<c:url value="../resources/js/customAjax.js"/>'></script>
	<script src='<c:url value="../resources/js/popper.min.js"/>'></script>
	<script src='<c:url value="../resources/js/bootstrap.min.js"/>'></script>
	<script
		src='<c:url value="../resources/js/jquery.superslides.min.js"/>'></script>
