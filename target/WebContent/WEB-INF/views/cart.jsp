...
<body>
			...
			<div class="container">
				...
				<div class="attr-nav">
					<ul>
						...
						<li class=""><a href="cart"> <i class="fa fa-shopping-bag"></i>
								<span class="badge">${giohang.size()}</span>
						</a></li>
					</ul>
				</div>
	...
	<div class="cart-box-main">
		<div class="container">
				...
				<div class="col-lg-12">
					<div class="table-main table-responsive">
						<table class="table" id="tbl">
							...
							<tbody class="CotGioHang">
								<c:forEach var="giohang" items="${giohang}">
									<tr name="${giohang.getMaSanPham()}" id="giohang">
										<td class="thumbnail-img"><a href="#"> <img
												class="img-fluid"
												src="<c:url value="./resources/image/products/${giohang.getHinhAnh()}"/>"
												alt="">
										</a></td>
										<td class="name-pr"><a href="#">
												${giohang.getTenSanPham()}</a></td>
										<td class="price-pr">
											<p id="donGiaGioHang">${giohang.getGiaTien()}</p>
										</td>
										<td class="quantity-box">
											<%-- <input type="number" size="4"
											id="soLuongGioHang" value="${giohang.getSoLuong()}" min="0"
											step="1" data-soluong="${giohang.getSoLuong()}"
											class="c-input-text qty text"> --%>
											<p id="soLuongGioHang">${giohang.getSoLuong()}</p>
										<td class="total-pr">
											<h3>
												<p id="tongTienGioHang"
													data-tongtien="${giohang.getTongTien()}">${giohang.getTongTien()}</p>
											</h3>
										</td>
										<td class="remove-pr"><a> <i class="fas fa-times"></i>
										</a></td>
									</tr>
								</c:forEach>
							</tbody>
			...
			<div class="row">
				<form id="formDatHang" onsubmit="return false">
					<div class="col-lg-6">
						<div class="order-box">
							<h3>Thông tin giao hàng</h3>
							<div class="mb-3">
								<label for="address">Họ và tên *</label> <input type="text"
									class="form-control" id="hoVaTen" placeholder="Họ và tên" value="${user.getHoTen()}"
									name="hoVaTen">
							</div>
							<div class="mb-3">
								<label for="email">Số điện thoại *</label> <input type="text"
									name="sdt" class="form-control" id="phone" value="${user.getSoDienThoai()}"
									placeholder="Số điện thoại">
							</div>
							<div class="mb-3">
								<label for="address">Địa chỉ *</label> <input type="text"
									name="diachi" class="form-control" id="address" value="${user.getDiaChi()}"
									placeholder="Đia chỉ" required="">
							</div>
					...
					<div class="col-lg-6">
						<div class="col-lg-12 col-sm-12">
							<div class="order-box">
								...
								<div class="d-flex">
									<h4>Tổng tiền</h4>
									<div class="ml-auto font-weight-bold" id="total">0</div>
								</div>
								<div class="d-flex">
									<h4>Phí ship</h4>
								...
								<div class="d-flex gr-total">
									<h5>Tổng cộng</h5>
									<div class="ml-auto h5" id="totalall">0</div>
								</div>
								<c:if test="${user != null}">
									<button type="submit" class="btn btn-warning" id="order">Đặt
										hàng</button>
								</c:if>
								<c:if test="${user == null}">
