...
<body>
	...
	<!-- Start Slider -->
	<div id="slides-shop" class="cover-slides slides-shop">
		<ul class="slides-container">
			<li class="text-left"><img
				src="<c:url value="./resources/image/slides/slide-1-full.jpg"/>"
				alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20">
								<strong>Chào mừng đến với shop <br> Stroyka
								</strong>
							</h1>
			...
			<li class="text-center"><img
				src="<c:url value="./resources/image/slides/slide-2-full.jpg"/>"
				alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="m-b-40">Hãy suy nghĩ khác biệt</p>
							<p>
								<a class="btn hvr-hover new-product" href="#">Sản phẩm mới</a>
							</p>
						</div>
					</div>
				</div></li>
			<li class="text-right"><img
				src="<c:url value="./resources/image/slides/slide-3-full.jpg"/>"
				alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
			...
			<div class="block-features__list">
				<div class="block-features__item">
					<div class="block-features__icon">
						<svg width="48px" height="48px">                       
                                <use
								xlink:href="<c:url value="./resources/image/sprite.svg#fi-free-delivery-48"/>"></use>
                            </svg>
					</div>
					<div class="block-features__content">
						<div class="block-features__title">Miễn phí ship</div>
						<div class="block-features__subtitle">Cho đơn trên 50.000</div>
					</div>
				</div>
				...
				<div class="block-features__item">
					<div class="block-features__icon">
						<svg width="48px" height="48px">
                                <use
								xlink:href="./resources/image/sprite.svg#fi-24-hours-48"></use>
                            </svg>
					</div>
					<div class="block-features__content">
						<div class="block-features__title">Hỗ trợ 24/7</div>
						<div class="block-features__subtitle">Gọi cho chúng tôi bất
							cứ khi nào</div>
					</div>
				</div>
				<div class="block-features__divider"></div>
				<div class="block-features__item">
					<div class="block-features__icon">
						<svg width="48px" height="48px">
                                <use
								xlink:href="./resources/image/sprite.svg#fi-payment-security-48"></use>
                            </svg>
					</div>
					<div class="block-features__content">
						<div class="block-features__title">100% An toàn</div>
						<div class="block-features__subtitle">Bảo mật thanh toán</div>
					</div>
				</div>
				<div class="block-features__divider"></div>
				<div class="block-features__item">
					<div class="block-features__icon">
						<svg width="48px" height="48px">
                                <use
								xlink:href="./resources/image/sprite.svg#fi-tag-48"></use>
                            </svg>
					</div>
					<div class="block-features__content">
						<div class="block-features__title">Khuyến mãi</div>
						<div class="block-features__subtitle">Giảm giá lên đến 90%</div>
					</div>
				</div>
			</div>
		</div>
						...
						<a class="disabled btn-warning  " aria-disabled="true"
							...
							<div class="products-single fix">
								<div class="box-img-hover">
									...
									<img
										src="<c:url value="./resources/image/products/${lay4sanpham.getHinhSanPham()}"/>"
										class="img-fluid" alt="Image">

								</div>
								<div class="why-text">
									<h4 class="font-weight-bold text-dark">${lay4sanpham.getTenSanPham()}</h4>
									<h5 class="text-dark">${lay4sanpham.getGiaTien()}</h5>
								</div>
							</div>
						</a>
					</div>
