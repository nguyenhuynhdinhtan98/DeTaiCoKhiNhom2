						...
						<div class="row justify-content-center">
							<div class="col-xl-7 col-lg-6 col-md-8">
								<div class="card flex-grow-1 mb-0 mt-5">
									<div class="card-body">
										<form id="formThemDanhMuc" onsubmit="return false">
											<div class="form-group">
												<label for="track-order-id">Tên Danh Mục</label> <input
													name="tendanhmucadd" id="tendanhmucadd" type="text"
											...
											<div class="form-group">
												<label for="track-order-id">Hình ảnh</label> <input
													...
													name="hinhAnhDanhMuc" accept='image/*'>
											</div>
											<div class="pt-3">
												<button type="submit" class="btn btn-success login"
													class="btnThemDanhMucSanPham" id="btnThemDanhMucSanPham">Lưu</button>
											</div>
										</form>
									</div>
								</div>
				...
				<table class="table">
					...
					<tbody>
						<c:forEach var="danhmuc" items="${danhmuc}">
							<tr>
								<th>${danhmuc.getMaDanhMucSanPham()}</th>
								...
								<td><div class="btn-group-horizontal">
										<a href="EditCategory/${danhmuc.getMaDanhMucSanPham()}"><button
												type="button" class="btn btn-success btn-lg"
												style="height: 45px">Sửa</button></a>
										<button type="button"
											class="btn btn-danger btn-lg removeCategory"
											style="height: 45px" id="removeCategory"
											value="${danhmuc.getMaDanhMucSanPham()}">Xoá</button>
									</div></td>
							</tr>
