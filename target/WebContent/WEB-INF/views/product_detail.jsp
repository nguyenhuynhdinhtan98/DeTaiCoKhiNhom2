...
<body>
		...
		<div class="container">
			<div class="row">
					...
					<div id="carouselExampleControls" class="carousel slide"
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img class="d-block w-100" id="hinhAnh"
									name="${sanpham.getHinhSanPham()}"
				...
				<div class="col-xl-7 col-lg-7 col-md-6">
					<div class="single-product-details">
						<h2 id="tensanpham">${sanpham.getTenSanPham()}</h2>
						<span style="float: left; margin-right: 10px;"><b>Mã
								SP:</b><b id="masanpham">${sanpham.getMaSanPham()} </b></span></br>
						<table>
							<tr>
								<td>Giá niêm yết:</td>
			...
			<div class="row my-5">
				<div class="col-lg-12">
					...
					<div class="row">
						<c:forEach var="sanpham" items="${sanpham3}">
							<div class="col-lg-4">
	...
	<script
		src='<c:url value="http://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.1/jquery.validate.min.js"/>'></script>
