...
CREATE TABLE ChiTietSanPham (
    MaChiTietSanPham INTEGER NOT NULL IDENTITY,
    MaSanPham INTEGER,
    SoLuong INTEGER,
...
insert into SanPham values ( 2 ,N'Kìm điện thép Nhật CR-V cao cấp Kapusi Japan 8 inch','900000',N'7" Kìm cắt Stanley 84-028 là sản phẩm được nhiều người sử dụng tin dùng bởi tính hữu ích và tiện lợi. Sản phẩm chính hãng của STANLEY sản xuất theo công nghệ hiện đại của Mỹ đảm bảo bạn sẽ yên tâm hơn về chất lượng.','product-7.jpg');
insert into SanPham values ( 3 ,N'Máy Phát Điện  HK3000','900000',N'Là một trong những máy phát điện hiện đang hot ở thị trường, có thiết kế nhỏ gọn. Máy phát điện sử dụng nguyên liệu xăng giúp tiết kiệm chi phí, sản phẩm đến từ Total, thương hiệu nổi tiếng, chất lượng hàng đầu về công cụ - dụng cụ. Máy có khả năng phát điện, cấp điện cho các thiết bị sử dụng nguồn điện 1 chiều 220V / 50Hz, phù hợp sử dụng tại các gia đình, cung cấp điện cho các thiết bị như: đèn, quạt, nồi cơm điện...','product-17.jpg');
insert into SanPham values (3 ,N'Máy phát điện Kama KGE2500X','20000',N'Là một trong những máy phát điện hiện đang hot ở thị trường, có thiết kế nhỏ gọn. Máy phát điện sử dụng nguyên liệu xăng giúp tiết kiệm chi phí, sản phẩm đến từ Total, thương hiệu nổi tiếng, chất lượng hàng đầu về công cụ - dụng cụ. Máy có khả năng phát điện, cấp điện cho các thiết bị sử dụng nguồn điện 1 chiều 220V / 50Hz, phù hợp sử dụng tại các gia đình, cung cấp điện cho các thiết bị như: đèn, quạt, nồi cơm điện...','product-18.jpg');
insert into SanPham values ( 3 ,N'Máy phát điện Kama KGE2500X ','900000',N'Là một trong những máy phát điện hiện đang hot ở thị trường, có thiết kế nhỏ gọn. Máy phát điện sử dụng nguyên liệu xăng giúp tiết kiệm chi phí, sản phẩm đến từ Total, thương hiệu nổi tiếng, chất lượng hàng đầu về công cụ - dụng cụ. Máy có khả năng phát điện, cấp điện cho các thiết bị sử dụng nguồn điện 1 chiều 220V / 50Hz, phù hợp sử dụng tại các gia đình, cung cấp điện cho các thiết bị như: đèn, quạt, nồi cơm điện...','product-19.jpg');
